...
-- Schema auditmoduledb
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `auditmoduledb` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `auditmoduledb` ;
...
-- -----------------------------------------------------
-- Table `auditmoduledb`.`tbl_industry_type_master`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `auditmoduledb`.`tbl_industry_type_master` ;

CREATE TABLE IF NOT EXISTS `auditmoduledb`.`tbl_industry_type_master` (
...
CREATE TABLE IF NOT EXISTS `auditmoduledb`.`tbl_company_details` (
  ...
  CONSTRAINT `tbl_company_details_ibfk_2`
    ...
    REFERENCES `auditmoduledb`.`tbl_industry_type_master` (`Industry_Type_ID`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
AUTO_INCREMENT = 99
...
-- -----------------------------------------------------
-- Table `auditmoduledb`.`tbl_compliance_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `auditmoduledb`.`tbl_compliance_type` ;

CREATE TABLE IF NOT EXISTS `auditmoduledb`.`tbl_compliance_type` (
...
-- -----------------------------------------------------
-- Table `auditmoduledb`.`tbl_xref_comp_type_mapping`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `auditmoduledb`.`tbl_xref_comp_type_mapping` ;

CREATE TABLE IF NOT EXISTS `auditmoduledb`.`tbl_xref_comp_type_mapping` (
  ...
  CONSTRAINT `tbl_xref_comp_type_mapping_ibfk_1`
    ...
    REFERENCES `auditmoduledb`.`tbl_compliance_type` (`Compliance_Type_ID`),
...
CREATE TABLE IF NOT EXISTS `auditmoduledb`.`tbl_compliance_audit` (
  ...
  CONSTRAINT `tbl_compliance_audit_ibfk_1`
    ...
    REFERENCES `auditmoduledb`.`tbl_xref_comp_type_mapping` (`Xref_Comp_Type_Map_ID`),
...
-- -----------------------------------------------------
-- Table `auditmoduledb`.`tbl_compliance_type_mapping`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `auditmoduledb`.`tbl_compliance_type_mapping` ;

CREATE TABLE IF NOT EXISTS `auditmoduledb`.`tbl_compliance_type_mapping` (
...
-- -----------------------------------------------------
-- Table `auditmoduledb`.`tbl_custom_audit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `auditmoduledb`.`tbl_custom_audit` ;

CREATE TABLE IF NOT EXISTS `auditmoduledb`.`tbl_custom_audit` (
...
-- -----------------------------------------------------
-- Table `auditmoduledb`.`tbl_custom_xref`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `auditmoduledb`.`tbl_custom_xref` ;

CREATE TABLE IF NOT EXISTS `auditmoduledb`.`tbl_custom_xref` (
