...
(p_Org_Hier_ID int,p_Compliance_Status varchar(100),p_Start_Date datetime, p_End_Date datetime, p_Compliance_Type_ID int)
begin 
if(p_Org_Hier_ID = 0)
then
...
and compliance_audit.End_Date <= p_End_Date and Compliance_Status= 'Complianced' 
...
and compliance_audit.Xref_Comp_Type_Map_ID in(
select compliance_audit.Xref_Comp_Type_Map_ID from compliance_audit where compliance_audit.Org_Hier_ID = p_Org_Hier_ID and
...
select distinct Compliance_Parent_ID from compliance_xref where compliance_xref.Compliance_Xref_ID in(
select xref_comp_type_mapping.Compliance_Xref_ID from xref_comp_type_mapping where xref_comp_type_mapping.Xref_Comp_Type_Map_ID in(
select compliance_audit.Xref_Comp_Type_Map_ID from compliance_audit where Org_Hier_ID = p_Org_Hier_ID and compliance_audit.Compliance_Status='Complianced')));
elseif(p_Compliance_Status= 'Non_Complianced')
then
...
select distinct Compliance_Parent_ID from compliance_xref where compliance_xref.Compliance_Xref_ID in(
select xref_comp_type_mapping.Compliance_Xref_ID from xref_comp_type_mapping where xref_comp_type_mapping.Xref_Comp_Type_Map_ID in(
select compliance_audit.Xref_Comp_Type_Map_ID from compliance_audit where Org_Hier_ID = p_Org_Hier_ID and compliance_audit.Compliance_Status='Non_Complianced')));
elseif(p_Compliance_Status= 'Partially_Complianced')
then
