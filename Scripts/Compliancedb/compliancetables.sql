...
-- -----------------------------------------------------
-- Table `compliancedb`.`user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `compliancedb`.`user` ;

CREATE TABLE IF NOT EXISTS `compliancedb`.`user` (
...
-- -----------------------------------------------------
-- Table `compliancedb`.`org_hier`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `compliancedb`.`org_hier` ;

CREATE TABLE IF NOT EXISTS `compliancedb`.`org_hier` (
  ...
  CONSTRAINT `fk_User`
    FOREIGN KEY (`User_ID`)
    REFERENCES `compliancedb`.`user` (`User_ID`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `compliancedb`.`branch_auditor_mapping`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `compliancedb`.`branch_auditor_mapping` ;

CREATE TABLE IF NOT EXISTS `compliancedb`.`branch_auditor_mapping` (
  ...
  CONSTRAINT `branch_auditor_mapping_ibfk_1`
    FOREIGN KEY (`Org_Hier_ID`)
    REFERENCES `compliancedb`.`org_hier` (`Org_Hier_ID`),
  CONSTRAINT `branch_auditor_mapping_ibfk_2`
    FOREIGN KEY (`Auditor_ID`)
    REFERENCES `compliancedb`.`user` (`User_ID`),
  CONSTRAINT `branch_auditor_mapping_ibfk_3`
...
-- -----------------------------------------------------
-- Table `compliancedb`.`country`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `compliancedb`.`country` ;

CREATE TABLE IF NOT EXISTS `compliancedb`.`country` (
...
-- -----------------------------------------------------
-- Table `compliancedb`.`state`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `compliancedb`.`state` ;

CREATE TABLE IF NOT EXISTS `compliancedb`.`state` (
  ...
  CONSTRAINT `FK_Country`
    ...
    REFERENCES `compliancedb`.`country` (`Country_ID`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `compliancedb`.`city`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `compliancedb`.`city` ;

CREATE TABLE IF NOT EXISTS `compliancedb`.`city` (
  ...
  CONSTRAINT `FK_State`
    ...
    REFERENCES `compliancedb`.`state` (`State_ID`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `compliancedb`.`branch_location`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `compliancedb`.`branch_location` ;

CREATE TABLE IF NOT EXISTS `compliancedb`.`branch_location` (
  ...
  CONSTRAINT `fk_OrgID`
    FOREIGN KEY (`Org_Hier_ID`)
    REFERENCES `compliancedb`.`org_hier` (`Org_Hier_ID`),
  CONSTRAINT `branch_location_ibfk_1`
    FOREIGN KEY (`Country_ID`)
    REFERENCES `compliancedb`.`country` (`Country_ID`),
  CONSTRAINT `branch_location_ibfk_2`
    FOREIGN KEY (`State_ID`)
    REFERENCES `compliancedb`.`state` (`State_ID`),
  CONSTRAINT `branch_location_ibfk_3`
    FOREIGN KEY (`City_ID`)
    REFERENCES `compliancedb`.`city` (`City_ID`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `compliancedb`.`industry_type_master`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `compliancedb`.`industry_type_master` ;

CREATE TABLE IF NOT EXISTS `compliancedb`.`industry_type_master` (
...
-- -----------------------------------------------------
-- Table `compliancedb`.`company_details`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `compliancedb`.`company_details` ;

CREATE TABLE IF NOT EXISTS `compliancedb`.`company_details` (
  ...
  CONSTRAINT `company_details_ibfk_1`
    FOREIGN KEY (`Org_Hier_ID`)
    REFERENCES `compliancedb`.`org_hier` (`Org_Hier_ID`),
  CONSTRAINT `company_details_ibfk_2`
    FOREIGN KEY (`Industry_Type_ID`)
    REFERENCES `compliancedb`.`industry_type_master` (`Industry_Type_ID`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `compliancedb`.`compliance_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `compliancedb`.`compliance_type` ;

CREATE TABLE IF NOT EXISTS `compliancedb`.`compliance_type` (
  ...
  INDEX `Industry_Type_ID` (`Industry_Type_ID` ASC),
  INDEX `Country_ID` (`Country_ID` ASC),
  CONSTRAINT `compliance_type_ibfk_1`
    FOREIGN KEY (`Industry_Type_ID`)
    REFERENCES `compliancedb`.`industry_type_master` (`Industry_Type_ID`),
  CONSTRAINT `compliance_type_ibfk_2`
    FOREIGN KEY (`Country_ID`)
    REFERENCES `compliancedb`.`country` (`Country_ID`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `compliancedb`.`compliance_xref`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `compliancedb`.`compliance_xref` ;

CREATE TABLE IF NOT EXISTS `compliancedb`.`compliance_xref` (
  ...
  INDEX `User_ID` (`User_ID` ASC),
  CONSTRAINT `compliance_xref_ibfk_1`
    FOREIGN KEY (`User_ID`)
    REFERENCES `compliancedb`.`user` (`User_ID`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `compliancedb`.`xref_comp_type_mapping`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `compliancedb`.`xref_comp_type_mapping` ;

CREATE TABLE IF NOT EXISTS `compliancedb`.`xref_comp_type_mapping` (
  ...
  CONSTRAINT `xref_comp_type_mapping_ibfk_1`
    FOREIGN KEY (`Compliance_Type_ID`)
    REFERENCES `compliancedb`.`compliance_type` (`Compliance_Type_ID`),
  CONSTRAINT `xref_comp_type_mapping_ibfk_2`
    FOREIGN KEY (`Compliance_Xref_ID`)
    REFERENCES `compliancedb`.`compliance_xref` (`Compliance_Xref_ID`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `compliancedb`.`compliance_audit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `compliancedb`.`compliance_audit` ;

CREATE TABLE IF NOT EXISTS `compliancedb`.`compliance_audit` (
  ...
  CONSTRAINT `compliance_audit_ibfk_1`
    FOREIGN KEY (`Xref_Comp_Type_Map_ID`)
    REFERENCES `compliancedb`.`xref_comp_type_mapping` (`Xref_Comp_Type_Map_ID`),
  CONSTRAINT `compliance_audit_ibfk_2`
    FOREIGN KEY (`Org_Hier_ID`)
    REFERENCES `compliancedb`.`org_hier` (`Org_Hier_ID`),
  CONSTRAINT `compliance_audit_ibfk_3`
    FOREIGN KEY (`Auditor_ID`)
    REFERENCES `compliancedb`.`user` (`User_ID`),
  CONSTRAINT `compliance_audit_ibfk_4`
...
-- -----------------------------------------------------
-- Table `compliancedb`.`compliance_audit_audittrail`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `compliancedb`.`compliance_audit_audittrail` ;

CREATE TABLE IF NOT EXISTS `compliancedb`.`compliance_audit_audittrail` (
  ...
  INDEX `Auditor_ID` (`Auditor_ID` ASC),
  INDEX `Vendor_ID` (`Vendor_ID` ASC),
  CONSTRAINT `compliance_audit_audittrail_ibfk_1`
    FOREIGN KEY (`Xref_Comp_Type_Map_ID`)
    REFERENCES `compliancedb`.`xref_comp_type_mapping` (`Xref_Comp_Type_Map_ID`),
  CONSTRAINT `compliance_audit_audittrail_ibfk_2`
    FOREIGN KEY (`Org_Hier_ID`)
    REFERENCES `compliancedb`.`org_hier` (`Org_Hier_ID`),
  CONSTRAINT `compliance_audit_audittrail_ibfk_3`
    FOREIGN KEY (`Auditor_ID`)
    REFERENCES `compliancedb`.`user` (`User_ID`),
  CONSTRAINT `compliance_audit_audittrail_ibfk_4`
    FOREIGN KEY (`Vendor_ID`)
    REFERENCES `compliancedb`.`org_hier` (`Org_Hier_ID`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `compliancedb`.`compliance_branch_mapping`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `compliancedb`.`compliance_branch_mapping` ;

CREATE TABLE IF NOT EXISTS `compliancedb`.`compliance_branch_mapping` (
  ...
  CONSTRAINT `Vendor_ID`
    ...
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `compliance_branch_mapping_ibfk_1`
    FOREIGN KEY (`Org_Hier_ID`)
    REFERENCES `compliancedb`.`org_hier` (`Org_Hier_ID`),
  CONSTRAINT `compliance_branch_mapping_ibfk_3`
    FOREIGN KEY (`UpdatedByLogin_ID`)
    REFERENCES `compliancedb`.`user` (`User_ID`),
  CONSTRAINT `compliance_branch_mapping_ibfk_4`
    FOREIGN KEY (`Xref_Comp_Type_Map_ID`)
    REFERENCES `compliancedb`.`xref_comp_type_mapping` (`Xref_Comp_Type_Map_ID`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `compliancedb`.`compliance_type_mapping`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `compliancedb`.`compliance_type_mapping` ;

CREATE TABLE IF NOT EXISTS `compliancedb`.`compliance_type_mapping` (
  ...
  INDEX `Org_Hier_ID` (`Org_Hier_ID` ASC),
  INDEX `Compliance_Type_ID` (`Compliance_Type_ID` ASC),
  CONSTRAINT `compliance_type_mapping_ibfk_1`
    FOREIGN KEY (`Org_Hier_ID`)
    REFERENCES `compliancedb`.`org_hier` (`Org_Hier_ID`),
  CONSTRAINT `compliance_type_mapping_ibfk_2`
    FOREIGN KEY (`Compliance_Type_ID`)
    REFERENCES `compliancedb`.`compliance_type` (`Compliance_Type_ID`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `compliancedb`.`compliance_xref_audittrail`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `compliancedb`.`compliance_xref_audittrail` ;

CREATE TABLE IF NOT EXISTS `compliancedb`.`compliance_xref_audittrail` (
  `Compliance_Xref_ID` INT(11) NOT NULL AUTO_INCREMENT,
  `Comp_Category` VARCHAR(45) NULL DEFAULT NULL,
  `Comp_Description` VARCHAR(800) NULL DEFAULT NULL,
  `Is_Header` BIT(1) NULL DEFAULT NULL,
  ...
  PRIMARY KEY (`Compliance_Xref_ID`),
  INDEX `User_ID` (`User_ID` ASC),
  CONSTRAINT `compliance_xref_audittrail_ibfk_1`
    FOREIGN KEY (`User_ID`)
    REFERENCES `compliancedb`.`user` (`User_ID`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `compliancedb`.`custom_audit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `compliancedb`.`custom_audit` ;

CREATE TABLE IF NOT EXISTS `compliancedb`.`custom_audit` (
  ...
  INDEX `Auditor_ID` (`Auditor_ID` ASC),
  INDEX `Vendor_ID` (`Vendor_ID` ASC),
  CONSTRAINT `custom_audit_ibfk_1`
    FOREIGN KEY (`Org_Hier_ID`)
    REFERENCES `compliancedb`.`org_hier` (`Org_Hier_ID`),
  CONSTRAINT `custom_audit_ibfk_2`
    FOREIGN KEY (`Auditor_ID`)
    REFERENCES `compliancedb`.`user` (`User_ID`),
  CONSTRAINT `custom_audit_ibfk_3`
    FOREIGN KEY (`Vendor_ID`)
    REFERENCES `compliancedb`.`org_hier` (`Org_Hier_ID`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `compliancedb`.`custom_xref`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `compliancedb`.`custom_xref` ;

CREATE TABLE IF NOT EXISTS `compliancedb`.`custom_xref` (
...
-- -----------------------------------------------------
-- Table `compliancedb`.`menus`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `compliancedb`.`menus` ;

CREATE TABLE IF NOT EXISTS `compliancedb`.`menus` (
...
-- -----------------------------------------------------
-- Table `compliancedb`.`privilege`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `compliancedb`.`privilege` ;

CREATE TABLE IF NOT EXISTS `compliancedb`.`privilege` (
...
-- -----------------------------------------------------
-- Table `compliancedb`.`role`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `compliancedb`.`role` ;

CREATE TABLE IF NOT EXISTS `compliancedb`.`role` (
...
-- -----------------------------------------------------
-- Table `compliancedb`.`role_priv_map`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `compliancedb`.`role_priv_map` ;

CREATE TABLE IF NOT EXISTS `compliancedb`.`role_priv_map` (
  ...
  CONSTRAINT `role_priv_map_ibfk_1`
    FOREIGN KEY (`Role_ID`)
    REFERENCES `compliancedb`.`role` (`Role_ID`),
  CONSTRAINT `role_priv_map_ibfk_2`
    FOREIGN KEY (`Privilege_ID`)
    REFERENCES `compliancedb`.`privilege` (`Privilege_ID`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `compliancedb`.`user_group`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `compliancedb`.`user_group` ;

CREATE TABLE IF NOT EXISTS `compliancedb`.`user_group` (
...
-- -----------------------------------------------------
-- Table `compliancedb`.`user_group_members`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `compliancedb`.`user_group_members` ;

CREATE TABLE IF NOT EXISTS `compliancedb`.`user_group_members` (
  ...
  CONSTRAINT `user_group_members_ibfk_1`
    FOREIGN KEY (`User_ID`)
    REFERENCES `compliancedb`.`user` (`User_ID`),
  CONSTRAINT `user_group_members_ibfk_2`
    FOREIGN KEY (`User_Group_ID`)
    REFERENCES `compliancedb`.`user_group` (`User_Group_ID`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `compliancedb`.`user_role_map`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `compliancedb`.`user_role_map` ;

CREATE TABLE IF NOT EXISTS `compliancedb`.`user_role_map` (
  ...
  INDEX `Role_ID` (`Role_ID` ASC),
  INDEX `User_ID` (`User_ID` ASC),
  CONSTRAINT `user_role_map_ibfk_1`
    FOREIGN KEY (`Role_ID`)
    REFERENCES `compliancedb`.`role` (`Role_ID`),
  CONSTRAINT `user_role_map_ibfk_2`
    FOREIGN KEY (`User_ID`)
    REFERENCES `compliancedb`.`user` (`User_ID`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `compliancedb`.`usergroup_menu_map`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `compliancedb`.`usergroup_menu_map` ;

CREATE TABLE IF NOT EXISTS `compliancedb`.`usergroup_menu_map` (
  ...
  CONSTRAINT `Menu_ID`
    FOREIGN KEY (`Menu_ID`)
    REFERENCES `compliancedb`.`menus` (`Menu_ID`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `compliancedb`.`vendor_branch_mapping`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `compliancedb`.`vendor_branch_mapping` ;

CREATE TABLE IF NOT EXISTS `compliancedb`.`vendor_branch_mapping` (
  ...
  INDEX `Vendor_ID` (`Vendor_ID` ASC),
  CONSTRAINT `vendor_branch_mapping_ibfk_1`
    FOREIGN KEY (`Branch_ID`)
    REFERENCES `compliancedb`.`org_hier` (`Org_Hier_ID`),
  CONSTRAINT `vendor_branch_mapping_ibfk_2`
    FOREIGN KEY (`Vendor_ID`)
    REFERENCES `compliancedb`.`org_hier` (`Org_Hier_ID`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
