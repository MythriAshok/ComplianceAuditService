...
INSERT INTO `tbl_role_priv_map` VALUES (4,1,4,1);
...
INSERT INTO `tbl_user` VALUES   
 (1,'pass','Admin',NULL,'Adani','admin@gmail.com','1234567890',1,'Male',1,'2018-07-17 15:33:10',NULL),
...
INSERT INTO `auditmoduledb`.`tbl_industry_type_master` (`Industry_Type_ID`, `Industry_Name`) VALUES ('1', 'Manufacturing');
INSERT INTO `auditmoduledb`.`tbl_industry_type_master` (`Industry_Type_ID`, `Industry_Name`) VALUES ('2', 'IT');
INSERT INTO `auditmoduledb`.`tbl_industry_type_master` (`Industry_Type_ID`, `Industry_Name`) VALUES ('3', 'Textiles');


INSERT INTO `auditmoduledb`.`tbl_compliance_type` (`Compliance_Type_Name`, `Industry_Type_ID`, `Country_ID`, `Audit_Frequency`, `End_Date`, `Start_Date`)
 VALUES ('Labour Compliance', 1, 1, 12, ('2020-12-31'), ('2018-01-01'));
 
 INSERT INTO `auditmoduledb`.`tbl_compliance_type` (`Compliance_Type_Name`, `Industry_Type_ID`, `Country_ID`, `Audit_Frequency`, `End_Date`, `Start_Date`) VALUES ('Statutory Compliance', 1, 1, 2, ('2020-12-31'), ('2018-01-01'));
INSERT INTO `auditmoduledb`.`tbl_compliance_type` (`Compliance_Type_Name`, `Industry_Type_ID`, `Country_ID`, `Audit_Frequency`, `End_Date`, `Start_Date`) VALUES ('Financial Compliance', 1, 1, 4, ('2020-12-31'), ('2018-01-01'));
INSERT INTO `auditmoduledb`.`tbl_compliance_type` (`Compliance_Type_Name`, `Industry_Type_ID`, `Country_ID`, `Audit_Frequency`, `End_Date`, `Start_Date`) VALUES ('Labour Compliance', 2, 1, 1, ('2020-12-31'), ('2018-01-01'));
INSERT INTO `auditmoduledb`.`tbl_compliance_type` (`Compliance_Type_Name`, `Industry_Type_ID`, `Country_ID`, `Audit_Frequency`, `End_Date`, `Start_Date`) VALUES ('Statutory Compliance', 2, 1, 4, ('2020-12-31'), ('2018-01-01'));
INSERT INTO `auditmoduledb`.`tbl_compliance_type` (`Compliance_Type_Name`, `Industry_Type_ID`, `Country_ID`, `Audit_Frequency`, `End_Date`, `Start_Date`) VALUES ('Labour Compliance', 1, 2, 12, ('2020-12-31'), ('2018-01-01'));
INSERT INTO `auditmoduledb`.`tbl_compliance_type` (`Compliance_Type_Name`, `Industry_Type_ID`, `Country_ID`, `Audit_Frequency`, `End_Date`, `Start_Date`) VALUES ('Financial Complianve', 1, 2, 6, ('2020-12-31'), ('2018-01-01'));
INSERT INTO `auditmoduledb`.`tbl_compliance_type` (`Compliance_Type_Name`, `Industry_Type_ID`, `Country_ID`, `Audit_Frequency`, `End_Date`, `Start_Date`) VALUES ('Statutoty Compliance', 2, 2, 4, ('2020-12-31'), ('2018-01-01'));
INSERT INTO `auditmoduledb`.`tbl_compliance_type` (`Compliance_Type_Name`, `Industry_Type_ID`, `Country_ID`, `Audit_Frequency`, `End_Date`, `Start_Date`) VALUES ('Financial Compliance', 2, 2, 1, ('2020-12-31'), ('2018-01-01'));
